...
$embed_url = DB::table('embed_report')->where('report_nm',$nama)->where('report_role','A')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm',$nama)->where('report_role','N')->first();
$table='dm dim_cabang';
$column='coyoutlet_id';
$table2='dm dim_cabang';
$column2='coyoutlet_id';
...
$embed_url = DB::table('embed_report')->where('report_nm',$nama)->where('report_role','C')->first();
$table='dm dim_cabang';
$column='coyoutlet_id';
$table2='dm dim_cabang';
$column2='coyoutlet_id';

...
class EmbedCollectionNavigationController extends Controller
{
...
//Get Parameter pembanding
    ...
    $report_name = DB::table('embed_report')->where('report_nm','CollectionNavigation')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','CollectionNavigation')->where('report_role','A')->first();
...
{
$embed_url = DB::table('embed_report')->where('report_nm','CollectionNavigation')->where('report_role','N')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','CollectionNavigation')->where('report_role','C')->first();

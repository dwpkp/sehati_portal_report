...
class EmbednbotController extends Controller
{
...
//Get Parameter pembanding
    ...
    $report_name = DB::table('embed_report')->where('report_nm','nbot')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','nbot')->where('report_role','A')->first();
...
{
$embed_url = DB::table('embed_report')->where('report_nm','nbot')->where('report_role','N')->first();
...
$value2 = $value;
$embed_url = DB::table('embed_report')->where('report_nm','nbot')->where('report_role','C')->first();
return view('EmbedFilter2',compact('value', 'value2' , 'token', 'embed_url'));
}
  }
}

...
class EmbedproyeksiController extends Controller
{
...
//Get Parameter pembanding
    ...
    $report_name = DB::table('embed_report')->where('report_nm','proyeksi')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','proyeksi')->where('report_role','A')->first();
...
{
$embed_url = DB::table('embed_report')->where('report_nm','proyeksi')->where('report_role','N')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','proyeksi')->where('report_role','C')->first();

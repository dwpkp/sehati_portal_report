...
class pvtController extends Controller
{
    ...
    public function index()
    {
        ...
        if ( $user_role->role == 'A' )
        {
          ...
          $report_name = DB::table('embed_report')->where('report_nm','pvt')->where('report_role','A')->first();
        }
        ...
        elseif ( $user_role->role == 'HO' )
        {
          ...
          $report_name = DB::table('embed_report')->where('report_nm','pvt')->where('report_role','N')->first();
        }
        else {
          ...
          $report_name = DB::table('embed_report')->where('report_nm','pvt')->where('report_role','C')->first();
        }

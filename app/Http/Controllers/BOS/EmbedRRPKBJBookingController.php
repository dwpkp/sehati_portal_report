...
class EmbedRRPKBJBookingController extends Controller
{
...
$embed_url = DB::table('embed_report')->where('report_nm','RRPKBJBooking')->where('report_role','A')->first();
...
{
$embed_url = DB::table('embed_report')->where('report_nm','RRPKBJBooking')->where('report_role','N')->first();
...
$embed_url = DB::table('embed_report')->where('report_nm','RRPKBJBooking')->where('report_role','C')->first();
return view('EmbedFilter1',compact('value' , 'token', 'embed_url'));
}
}
}

...
class RiskIndikatorController extends Controller
{
    ...
    public function index()
    {
        ...
        {
          $nickname = collect(['name' => 'NASIONAL']);
        }
        else {
        ...
        $report_name = 'Profile Booking';

    return view('report', compact('datas','report_name','nickname'));
    }

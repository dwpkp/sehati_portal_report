...
class EmbedppriController extends Controller
{
  ...
  //Get Parameter pembanding
      ...
      $report_name = DB::table('embed_report')->where('report_nm','ppri')->first();
  ...
  $embed_url = DB::table('embed_report')->where('report_nm','ppri')->where('report_role','A')->first();
  ...
  {
  $embed_url = DB::table('embed_report')->where('report_nm','ppri')->where('report_role','N')->first();
  ...
  else
  {
    ...
    $embed_url = DB::table('embed_report')->where('report_nm','ppri')->where('report_role','C')->first();

...
class EmbedKKManagementController extends Controller
{
  ...
  //Get Parameter pembanding
      ...
      $report_name = DB::table('embed_report')->where('report_nm','kkm')->first();
  ...
  $embed_url = DB::table('embed_report')->where('report_nm','kkm')->where('report_role','A')->first();
  ...
  {
  $embed_url = DB::table('embed_report')->where('report_nm','kkm')->where('report_role','N')->first();
  ...
  else
  {
    ...
    $value2 = DB::connection('oracle')->table('APPL.RPT_ROLE_AREA')->select('area_name')->where('PERSON_EMPL_ID',[Auth::user()->npk])->pluck('area_name');
    $embed_url = DB::table('embed_report')->where('report_nm','kkm')->where('report_role','C')->first();
